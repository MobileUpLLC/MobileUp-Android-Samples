...
import ru.mobileup.samples.features.collapsing_toolbar.presentation.CollapsingToolbarComponentUi
...
fun RootUi(
    ...
    Children(childStack, modifier) { child ->
        when (val instance = child.instance) {
            ...
            is RootComponent.Child.CollapsingToolbar -> CollapsingToolbarComponentUi(instance.component)
        }
    }
