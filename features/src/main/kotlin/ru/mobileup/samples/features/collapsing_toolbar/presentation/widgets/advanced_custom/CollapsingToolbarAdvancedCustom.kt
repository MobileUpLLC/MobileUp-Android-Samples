package ru.mobileup.samples.features.collapsing_toolbar.presentation.widgets.advanced_custom
...
@Composable
fun CollapsingToolbarAdvancedCustom(
    scrollValue: Int,
    modifier: Modifier = Modifier,
    leadingIconImageVector: ImageVector = Icons.AutoMirrored.Filled.ArrowBack
) {
    val ctx = LocalContext.current
    val params = remember { CollapsingToolbarAdvancedCustomParams() }
...
private fun MeasureScope.content(
    params: CollapsingToolbarAdvancedCustomParams,
...
private fun MeasureScope.getPlayerPhotoPlaceable(
    params: CollapsingToolbarAdvancedCustomParams.Player.Photo,
    measures: List<Measurable>,
    scrollFraction: Float
): Placeable? {
...
private fun MeasureScope.getLeadingIconPlaceable(
    params: CollapsingToolbarAdvancedCustomParams.LeadingIcon,
    measures: List<Measurable>
) =
